                ...
                for k in range(len(contributors)):
                    if contributors[k][2] != 0 and contributors[k][0] not in projects[i][7]:
                        ...
                        for l in range(len(contributors[k][1])):
                            ...
                            if contributors[k][1][l][0] == projects[i][5][j][0] and contributors[k][1][l][1] >= projects[i][5][j][1]:
                                #print("Found contributor for later: " + contributors[k][0])
...
if __name__ == "__main__":
    ...
    nbrContributeurs, nbProjects, contributors, projects = readFile("input_data/b_better_start_small.in.txt")
    #print(projects)
    firstRun()
    projects_done = 0
    for i in range(len(projects)):
    ...
    outputer(output_projects, 'b_out.txt')
